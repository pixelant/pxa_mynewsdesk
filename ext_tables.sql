#
# Table structure for table 'tx_pxamynewsdesk_domain_model_importlog'
#
CREATE TABLE tx_pxamynewsdesk_domain_model_importlog (

	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,

	hash varchar(255) DEFAULT '' NOT NULL,
	newstable varchar(255) DEFAULT '' NOT NULL,
	newsid int(11) DEFAULT '0' NOT NULL,
	newspid int(11) DEFAULT '0' NOT NULL,
